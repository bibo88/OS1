...
/******************** Main Program ********************/
int main(void){
	int sd, len, choice, trans_type, acc_exists, allow_with;
	struct sockaddr sa;

	/*
	* Create the user interface menu
	*/
	...
	*/
	write(sd, &trans_type, sizeof(int));
